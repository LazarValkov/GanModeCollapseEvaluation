...
if __name__ == '__main__':
    ...
    for i in xrange(start_index, start_index+runs):
        flags = {
            ...
            "sample_num": 64,
            "epoch": 1,  # "Epoch to train [100]"
            "dataset": "cifar10",  # "The name of dataset [celebA, mnist, lsun, mnist_stacked, cifar10]"
            ...
            "eval_infvo_lbfgsb_maxiter": 5,    # "UnrolledGAN's Inferene via Optimization evaluation.
